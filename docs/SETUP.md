...
> GitHub readers: the same guide also lives at the repository root as [`SETUP.md`](../SETUP.md).
...
Overview: [README.md](../README.md) · Configuration: [CONFIGURATION.md](CONFIGURATION.md) · Releases: [RELEASES.md](RELEASES.md).
...
More CLI-oriented notes: [docs/troubleshooting.md](troubleshooting.md) · [docs/FAQ.md](FAQ.md).
